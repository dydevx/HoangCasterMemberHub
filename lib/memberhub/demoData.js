...
export const demoCustomers = [
  { id: 1, user_id: null, shop_id: 1, name: "Nguyễn Minh Anh", email: "minh.anh@example.com", phone: "0900000003", birthday: "1996-05-14", gender: "Nữ", address: "Quận Bình Thạnh, TP.HCM", notes: "Ưu tiên lịch cuối tuần", avatar_url: "", status: "active", created_at: "2026-06-01T09:00:00Z" },
...
export function getDemoRawData() {
  const customers = demoCustomers.map((customer) => (
    customer.id === 1
      ? { ...customer, user_id: 3, slug: customer.slug || "nguyen-minh-anh" }
      : customer
  ));
