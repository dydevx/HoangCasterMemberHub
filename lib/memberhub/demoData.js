export const demoCredentials = {
  ...
  super_admin: { email: "admin@example.com", password: "Admin@123" },
  owner: { email: "owner@example.com", password: "Owner@123" },
  store_owner: { email: "owner@example.com", password: "Owner@123" },
  customer: { email: "minh.anh@example.com", password: "Customer@123" }
};

const demoPasswordOverrides = new Map();

export const demoUsers = [
  { id: 1, name: "System Admin", email: demoCredentials.admin.email, role: "super_admin", status: "active", phone: "0900000001", locale: "vi" },
  { id: 2, name: "Lumi Spa Owner", email: demoCredentials.owner.email, role: "store_owner", status: "active", phone: "0900000002", locale: "vi" },
  { id: 3, name: "Nguyen Minh Anh", email: demoCredentials.customer.email, role: "customer", status: "active", phone: "0900000003", locale: "vi" },
  { id: 4, name: "Tran Quoc Bao", email: "bao.tran@example.com", role: "customer", status: "active", phone: "0900000004", locale: "vi" },
  { id: 5, name: "Le Thu Ha", email: "ha.le@example.com", role: "customer", status: "active", phone: "0900000005", locale: "vi" },
  { id: 6, name: "Pham Gia Linh", email: "linh.pham@example.com", role: "customer", status: "active", phone: "0900000006", locale: "vi" }
];

export const demoShops = [
  { id: 1, name: "Lumi Spa Quận 1", slug: "lumi-spa-quan-1", address: "12 Nguyễn Huệ, Quận 1, TP.HCM", phone: "028 1111 2222", email: "hello@lumispa.vn", owner_id: null, status: "active", industry: "Spa" },
  { id: 2, name: "Nova Fitness Thủ Đức", slug: "nova-fitness-thu-duc", address: "88 Võ Văn Ngân, TP. Thủ Đức", phone: "028 3333 4444", email: "team@novafit.vn", owner_id: null, status: "active", industry: "Gym" },
  { id: 3, name: "Pearl Nail Đà Nẵng", slug: "pearl-nail-studio", address: "45 Lê Lợi, Đà Nẵng", phone: "0236 111 999", email: "care@pearlnail.vn", owner_id: null, status: "active", industry: "Nail Salon" }
];

export const demoStoreUsers = [
  { id: 1, store_id: 1, user_id: 2, role: "store_owner", created_at: "2026-06-01T08:00:00Z" }
];

export const demoCustomers = [
  { id: 1, user_id: 3, shop_id: 1, name: "Nguyễn Minh Anh", email: "minh.anh@example.com", phone: "0900000003", birthday: "1996-05-14", gender: "Nữ", address: "Quận Bình Thạnh, TP.HCM", notes: "Ưu tiên lịch cuối tuần", avatar_url: "", status: "active", created_at: "2026-06-01T09:00:00Z" },
  { id: 2, user_id: 4, shop_id: 1, name: "Trần Quốc Bảo", email: "bao.tran@example.com", phone: "0900000004", birthday: "1992-09-20", gender: "Nam", address: "Quận 3, TP.HCM", notes: "Ứng viên nâng hạng Gold", avatar_url: "", status: "active", created_at: "2026-06-03T10:00:00Z" },
  { id: 3, user_id: 5, shop_id: 2, name: "Lê Thu Hà", email: "ha.le@example.com", phone: "0900000005", birthday: "1998-02-11", gender: "Nữ", address: "Thủ Đức, TP.HCM", notes: "Tập PT mỗi thứ ba", avatar_url: "", status: "active", created_at: "2026-06-07T11:00:00Z" },
  { id: 4, user_id: 6, shop_id: 3, name: "Phạm Gia Linh", email: "linh.pham@example.com", phone: "0900000006", birthday: "1994-12-02", gender: "Nữ", address: "Hải Châu, Đà Nẵng", notes: "Thành viên nail art", avatar_url: "", status: "active", created_at: "2026-06-10T11:20:00Z" }
];
...
export function getDemoPasswordForRole(role) {
  return demoPasswordOverrides.get(role) || demoCredentials[role]?.password || "";
}

export function setDemoPasswordForRole(role, password) {
  if (!demoCredentials[role]) return false;
  demoPasswordOverrides.set(role, String(password || ""));
  return true;
}
