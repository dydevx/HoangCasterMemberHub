...
const vi = {
  ...
  "app.chooseWorkspace": "Chọn khu vực làm việc",
  "app.workspaceCopy": "Mỗi vai trò mở một không gian vận hành riêng với dữ liệu theo shop_id, báo cáo, thẻ, dịch vụ, ưu đãi và giao dịch.",
  "app.admin": "Super Admin",
  ...
  "auth.demo": "Tài khoản demo đã được điền sẵn.",
  ...
  "dashboard.tenantIsolation": "Tách dữ liệu tenant",
  "dashboard.tenantCopy": "Mỗi bản ghi vận hành được lọc bằng shop_id trước khi hiển thị.",
